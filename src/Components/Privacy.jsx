...
const Privacy = () => {
    ...
    const defaultStyle = {
      ...
      const policyContainerStyle = {
        maxHeight: "472px", // Set maximum height for scrollable content
    ...
    return (
        ...
        <div style={{gap:"38em"}} className="right-header">
                    <div style={{width:"26%"}} className="header-left-container">
                        <span style={{fontWeight:"800"}} className="name">Privacy Policy</span>
                    </div>
      ...
      <div style={policyContainerStyle}>
        ...
        <p>The collected data is used to personalize your experience, improve our website, and provide customer support.</p>
        ...
        <p>We employ security measures to ensure the safety of your personal information.</p>
        ...
        <p>We may update our privacy policy from time to time. We will notify you of any changes by posting the new policy on this page.</p>
                        ...
                        <div className="check-container" style={{ display: "flex", alignItems: "center", justifyContent: "flex-start" ,position: "absolute", bottom: 0,padding
: "20px", paddingLeft:"46px"
                        }}>
      {/* Checkbox and Label */}
      <div style={{ display: "flex", alignItems: "center", paddingleft:" 20px "}}>
        <div style={isColored ? coloredStyle : defaultStyle} onClick={handleClick}>
          {isColored && "✔"}
        </div>
      ...
      <div className="modal-actions" style={{ display: "flex", gap: "10px" }}>
        <button className="btn-bottom" type="button">
          Decline
        </button>
        <button style={{ backgroundColor: "#007b9e",color:"white"}}className="btn-bottom" type="submit">
          Accept
        </button>
      </div>
    </div>
