...
const Dashboard = () => {
  ...
  return (
    <div className="dash-container">
        ...
        <div className="buttons-container">
          <div className="nav-left-buttons-container">
            <ul>
              ...
              <li
                onClick={() => setActiveScreen("Sora Health")}
                className={`nav-button ${isActive("Sora Health")}`}
              >
                <BsHeartPulseFill size={20} style={{ marginRight: "10px" }} />
                Sora Health
              </li>
              <li
                onClick={() => setActiveScreen("Connecting Records")}
                className={`nav-button ${isActive("Connecting Records")}`}
              >
              ...
              <li
                ...
                className={`nav-button ${isActive("Benefits")}`}
              >
                <FaHandHoldingHeart size={20} style={{ marginRight: "10px" }} />
                Benefits
              </li>
              <li
                onClick={() => setActiveScreen("Find a Caregiver")}
                className={`nav-button ${isActive("Find a Caregiver")}`}
              >
      ...
      <div className="right-container">{renderActiveScreen()}</div>
    </div>
  );
};
